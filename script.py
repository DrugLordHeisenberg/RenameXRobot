class script(object):
    START_TEXT = """Hello,
I'm a Simple File Renamer × Robot With Permanent Thumbnail support, Made by @DoctorStrangeRobot
...
© @DoctorStrangeRobot""" 
    ...
    UPGRADE_TEXT = "CONTACT @LuciferMorningstarRobot"
    DOWNLOAD_START = "Give Me Some Time...🕵🏻‍♂️"
    UPLOAD_START = "Starting to upload..."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me > ©  @DoctorStrangeRobot **"
